...
function MailCheck() {
  ...
  const handleEmailCheck = async () => {
    const response = await fetch('https://student-teacher-project2.onrender.com/users/checkmail', {
      method: 'POST',
  ...
  const handlePasswordReset = async () => {
    const response = await fetch(`https://student-teacher-project2.onrender.com/users/checkstring?token=${string}`, {
      method: 'POST',
